...
public class AddNumbersTestTaskTest {

    @Test
    public void testAddSeveralOneDigitNumbers() {
        String resultString = AddNumbersTestTask.addNumbers("1 2 3 4", "3 2 1 0");
        Assert.assertEquals(resultString, "4 4 4 4");
    }

    @Test
    public void testAddSeveralDigitsNumbers() {
        String resultString = AddNumbersTestTask.addNumbers("123 456 789", "11 22 33");
        Assert.assertEquals(resultString, "134 478 822");
    }

    @Test
    public void testAddTwoZeros() {
        String resultString = AddNumbersTestTask.addNumbers("0", "0");
        Assert.assertEquals(resultString, "0");
    }

    @Test
    public void testAddDecimalOnlyNumbers() {
        String resultString = AddNumbersTestTask.addNumbers("1234567.8901 2.345", "12.34 2345678901.2");
    ...
    public void testAddDecimalNumbersWhenSumIsWithZeroDecimalPart() {
        String resultString = AddNumbersTestTask.addNumbers("1.9 8.33", "2.1 13.67");
        Assert.assertEquals(resultString, "4 22");
    }

    @Test
    public void testAddDecimalAndIntegerNumbers() {
        String resultString = AddNumbersTestTask.addNumbers("99 2.345", "1.19876 2345678901");
        Assert.assertEquals(resultString, "100.19876 2345678903.345");
    }

    @Test
    public void testAddBigIntegers() {
        String resultString = AddNumbersTestTask.addNumbers("123456789012345678901 23456789", "12345678 234567890123456789012");
        Assert.assertEquals(resultString, "123456789012358024579 234567890123480245801");
    }

    @Test
    public void testAddBigDecimals() {
        String actualResult = AddNumbersTestTask.addNumbers(
    ...
    public void firstNotValidLineThrowsException() {
        Assert.assertThrows(
                "Only numbers and spaces are expected",
                IllegalArgumentException.class,
                () -> AddNumbersTestTask.addNumbers("1 2 a", "3 2 1")
        );
    }
    ...
    public void secondNotValidLineThrowsException() {
        Assert.assertThrows(
                "Only numbers and spaces are expected",
                IllegalArgumentException.class,
                () -> AddNumbersTestTask.addNumbers("1 2 3", "? 2 1")
        );
    }
